...
* **Projeto Bônus (Zero-Trust Access):** `projects/project-3-secure-enterprise-access/` — Eliminação da porta 22 (SSH) da internet em favor do AWS Systems Manager Session Manager, com auditoria criptografada no Amazon S3 e integração federada com Microsoft Entra ID (Azure AD).
